...
const getProductosByCategoria = async (req, res) => {
  try {
    ...
    const [seccionesRelacionadas] = await pool.execute(
      querySeccionesRelacionadas,
      [idCategoria]
    );
...
const createProducto = async (req, res) => {
  ...
  let connection;
  console.log("imagen_extra1:", imagen_extra1, "tipo:", typeof imagen_extra1);
  console.log("imagen_extra2:", imagen_extra2, "tipo:", typeof imagen_extra2);
  const imagenExtra1 = imagen_extra1 ?? null;
  const imagenExtra2 = imagen_extra2 ?? null;
  ...
  try {
    ...
    const productoConImagenes = {
      ...
      imagenPrincipal: producto[0].imagenPrincipal
        ...
        : null,
      imagen2: producto[0].imagen2
        ? `${process.env.BASE_URL}/uploads/productos/${producto[0].imagen2}`
        : null,
      imagen3: producto[0].imagen3
        ? `${process.env.BASE_URL}/uploads/productos/${producto[0].imagen3}`
        : null,
    };
...
const updateProducto = async (req, res) => {
  ...
  try {
    ...
    const camposActualizados = {
      ...
      id_seccion:
        idSeccion !== undefined ? idSeccion : productoActual.id_seccion,
      es_destacado:
        destacado !== undefined
          ? destacado
            ? 1
            : 0
          : productoActual.es_destacado,
